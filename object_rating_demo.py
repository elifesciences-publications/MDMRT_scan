...
def instructions():
    ...
    text3=font.render("This is a demo of the task. Please click to continue..",1,white)
...
def write_header():
    ...
    sepname=subjid+"_object_rating_demo.txt"
...
def end():
    screen.fill((0, 0, 0))
    text=font2.render("Thank you! We will continue with this task.",1,yellow)
    textpos=text.get_rect(centerx=width/2, centery=height/2)
    screen.blit(text, textpos)
    pygame.display.flip()
...
stimlist=['201.bmp','202.bmp','203.bmp','204.bmp']
